...
func chatHistoryEntriesForView(
    ...
    loop: for entry in view.entries {
        ...
        if !currentWinterGramSettings.shadowBanIds.isEmpty, let author = message.author, currentWinterGramSettings.shadowBanIds.contains(author.id.id._internalGetInt64Value()) {
            continue
        }
