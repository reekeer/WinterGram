...
public final class PeerInfoGiftsCoverComponent: Component {
    ...
    public let additionalGifts: [ProfileGiftsContext.State.StarGift]
    ...
    public init(
        ...
        additionalGifts: [ProfileGiftsContext.State.StarGift] = [],
        hasBackground: Bool,
        ...
        self.additionalGifts = additionalGifts
    ...
    public static func ==(lhs: PeerInfoGiftsCoverComponent, rhs: PeerInfoGiftsCoverComponent) -> Bool {
        ...
        if lhs.additionalGifts != rhs.additionalGifts {
            return false
        }
        return true
    }
    ...
    public final class View: UIView {
        ...
        private var currentGiftStatusId: Int64?
        ...
        private func recomputeGifts() {
            ...
            var mergedGifts = pinnedGifts
            for gift in self.component?.additionalGifts ?? [] {
                if !mergedGifts.contains(where: { $0.reference == gift.reference }) {
                    mergedGifts.append(gift)
                }
            }
        ...
        func update(component: PeerInfoGiftsCoverComponent, availableSize: CGSize, state: EmptyComponentState, environment: Environment<Empty>, transition: ComponentTransition) -> CGSize {
            ...
            if previousComponent?.additionalGifts != component.additionalGifts {
                self.recomputeGifts()
            }
            ...
            if self.giftsDisposable == nil {
                self.giftsDisposable = combineLatest(
                    ...
                    self.currentGiftStatusId = giftStatusId
                    self.recomputeGifts()
                })
            }
