...
public final class PieChartComponent: Component {
    public struct ChartData: Equatable {
        public struct Item: Equatable {
            ...
            public init(id: AnyHashable, displayValue: Double, displaySize: Int64, value: Double, color: UIColor, particle: String?, title: String, mergeable: Bool, mergeFactor: CGFloat) {
                self.id = id
    ...
    public static func ==(lhs: PieChartComponent, rhs: PieChartComponent) -> Bool {
